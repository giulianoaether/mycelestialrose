      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        >
          ...
          <img
            ...
            width={460}
            height={460}
            className="relative z-10 h-[44vh] max-h-[460px] w-auto animate-float-slow drop-shadow-2xl"
            style={{ filter: "drop-shadow(0 0 40px oklch(0.62 0.14 18 / 0.5))" }}
          />
        </motion.div>

        <h2 className="mt-16 max-w-3xl font-serif text-3xl italic leading-tight glow-text-soft sm:text-4xl md:text-5xl">
        ...
        <RevealText
          delay={4}
          className="mt-10 max-w-xl font-serif text-base italic leading-relaxed text-foreground/60 sm:text-lg"
        >
        ...
        <SectionTransition to="/cativar" label="Continuar" />
      </section>
    </main>
  );
}
